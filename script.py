...
while True:
	...
	if console == "help":
		...
		iplookup = requests.get(base_url)



		response = iplookup.json()




		print(b + "                     Username:" + r , username)
		print (b + "                     User path:" + r , os.environ['USERPROFILE'])
		print(b, "#" + "-" * 80 + "#")
		print(b, "                    System Information:")
		print(r, f"                    Manufacturer: {my_system.Manufacturer}")
		print(r, f"                    Model: {my_system. Model}")
		print(r, f"                    Name: {my_system.Name}")
		print(r, f"                    NumberOfProcessors: {my_system.NumberOfProcessors}")
		print(r, f"                    SystemType: {my_system.SystemType}")
		print(r, f"                    SystemFamily: {my_system.SystemFamily}")

		print(b, "#" + "-" * 80 + "#")
		print(b, "                    Network Information:")
		print(r, "                    Local IP Address: " + local_ip)
		print(r, "                    Public IP Address: " + response)
